defmodule AvalieTechWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(AvalieTechWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(AvalieTechWeb.Gettext, "errors", msg, opts)
    end
  end
